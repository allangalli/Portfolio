...
summary: "Built a voice AI health companion using RAG to address the 40-80% of patients who forget medical details. HIPAA-compliant with Twilio integration, deployed on Railway with GPT-4, hybrid vector search, and Redis caching for 3.4x performance improvement."
images:
  - "/images/projects/vitalnudge/cover.png"
link: ""
